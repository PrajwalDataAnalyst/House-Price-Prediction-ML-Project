...
def predict():
    ...
    loc_index = data_columns.index(location.lower()) if location.lower() in data_columns else None
    if loc_index is None:
        return render_template('index.html', prediction_text='Location not found. Please try again.')
